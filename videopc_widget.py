...
class VideoPointCloudTab(QWidget):
    ...
    def __init__(self, parent=None) -> None:
        ...
        # Sensor-Höhe zur Boden-Kompensation
        ctrl.addWidget(QLabel("Sensor-H [m]:"))
        self.spn_h = QDoubleSpinBox(); self.spn_h.setRange(0, 5); self.spn_h.setValue(1.3)
        ctrl.addWidget(self.spn_h)
    ...
    def draw_scatter(self, pts_raw) -> None:
        ...
        stack[:, 2] -= self.spn_h.value()  # Sensorhöhe berücksichtigen
