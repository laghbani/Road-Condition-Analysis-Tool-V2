...
class BagReaderWorker(QThread):
    ...
    def run(self) -> None:
        try:
            ...
            self.finished.emit((samples, gps, imu_topics, gps_topic), None)
...
class MainWindow(QMainWindow):
    ...
    def _set_defaults(self) -> None:
        ...
        available = self.available_topics or list(self.samples)
